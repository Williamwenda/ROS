...
// (in-package beginner_tutorails.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'beginner_tutorails/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'beginner_tutorails/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'beginner_tutorails/AddTwoInts'; }
};
